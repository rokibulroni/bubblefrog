function CCreditsPanel(){
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLinkOutline = new createjs.Text("www.rokibulroni.com", "18px " + FONT_GAME, "#008733");
	...
	_oLinkOutline.x = CANVAS_WIDTH/2;
        ...
        _oLink = new createjs.Text("www.rokibulroni.com", "18px " + FONT_GAME, "#fff");
    ...
    this._onLogoButRelease = function(){
        window.open("https://www.rokibulroni.com/category/projects/","_blank");
    };
